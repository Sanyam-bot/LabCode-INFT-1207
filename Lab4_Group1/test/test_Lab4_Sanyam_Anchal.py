...
class TestDefaultSuite:
    ...
    def test_male_all_invalid_type(self):
        ...
        self.driver.find_element(By.ID, "cheightmeter").click()  # Weight
        self.driver.find_element(By.ID, "cheightmeter").send_keys("one seventy")  # Send keys to Weight
        self.driver.find_element(By.ID, "cneckmeter").click()  # Weight
        self.driver.find_element(By.ID, "cneckmeter").send_keys("fifty")  # Send keys to Weight
        self.driver.find_element(By.ID, "cwaistmeter").click()  # Waist
